...
def tree_map_with_edgemapper_Test():
    data = query.get_comments_in_article("bujyfn")
    mapper = EdgeMapper(data)
    data = mapper.cluster
        
    # Make a tree, using the article node as the root
    root = TreeNode("bujyfn")
    ...
    # print(JsonResponse(hierarchy["children"]))
    # print("After print JsonResponse")
    return JsonResponse({"data":hierarchy})

if __name__ == "__main__":
    tree_map_with_edgemapper_Test()